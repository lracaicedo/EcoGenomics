...
pca1 # prints summary
pca1
pca1$eig[1]/sum(pca1$eig)*100# variation explained by pc1
pca1$eig[2]/sum(pca1$eig)*100 # variation explained by pc2
...
plot(pca1$scores[,1], pca1$scores[,2], 
     ...
     xlab="Principal Component 1 (6.203822)", 
     ylab="Principal Component 2 (5.821741)", 
     main="PCA on SSW data (title)")
legend("topleft", 
...
plot(pca1$scores[,1], pca1$scores[,2], 
     cex=2, pch=20, col=as.factor(unlist(gl1$other$Trajectory)), 
     xlab="Principal Component 1 (6.203822%)", 
     ylab="Principal Component 2 (5.821741%)")
legend("topleft", 
       legend=unique(unlist(gl1$other)), 
       pch=20, 
       col=as.factor(unique(unlist(gl1$other))))
