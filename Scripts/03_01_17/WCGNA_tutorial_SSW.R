...
# Download the example data from: https://labs.genetics.ucla.edu/horvath/CoexpressionNetwork/Rpackages/WGCNA/Tutorials/FemaleLiver-Data.zip
...
# workingDir = ".";
# setwd(workingDir); 
# setwd("~/Dropbox/2_Teaching/WGCNA/tutorial")
# setwd("~/Dropbox/1_Research/SSW/DGE/WGCNA")
...
################################## PART 2: one-step network construction and module detection
...
######################## Part 3: Relating modules to external traits and identifying important genes
